# openclaw-inwx - Next Actions

## P5 - Release Preparation

- [ ] Add git remote once GitHub repo is created
- [ ] Push current `main` branch to remote
- [ ] Create initial release tag after review

## P6 - Optional Validation

- [ ] Add OTE credential-backed integration tests (safe, no billing)
